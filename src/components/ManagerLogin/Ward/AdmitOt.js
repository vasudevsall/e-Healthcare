...
class AdmitOt extends Component {
    ...
    componentDidMount() {
        ...
        AccomodationService.getAllOtInfo()
        .then((resp) => {
            if(!this.toUnmount) {
                this.setState({
                    rooms: resp.data,
            ...
            if(!this.toUnmount) {
                this.setState({
                    errMess: 'Unable to fetch ot details'
                })
            }
        });
    ...
    handleAdmitPatient(event) {
        ...
        AccomodationService.admitOt(this.state.selectedRoom, this.state.phone, this.state.details,
                    ...
                    <tr key={room.otNo}>
                        ...
                        <td>
                            <button className='btn btn-outline-danger btn-sm' 
                                id={`ot-patient-${room.otNo}`}
                                onClick={() => this.openModal(room.otNo)}
                                disabled = {!room.vacant}
                            >
                                <span className='fa fa-plus-square'></span>
                            </button>
                            <UncontrolledTooltip target={`ot-patient-${room.otNo}`} placement='right'>
                                Admit Patient
                            </UncontrolledTooltip>
                        </td>
                    </tr>
                    ...
                    <ModalBody>
                        <div className='container'>
                            ...
                            <Form onSubmit={this.handleAdmitPatient}>
                                <FormGroup row>
                                    <Label htmlFor='form-room' sm={4}>OT Number:</Label>
                                    <Col sm={7}>
                                        <Input type='text'
                                            id = 'form-room'
...
export default withRouter(AdmitOt);