...
class NewAppointment extends Component {
    ...
    handleFormSubmit(event) {
        ...
        AppointmentService.postNewAppointment(this.state.phone ,this.state.doctor, this.state.appointment)
            .then((resp) => {
                this.setState({
    ...
    handleChange(event) {
        ...
        if(name === 'doctor') {
            InfoService.getDoctorSchedule(value)
                ...
                .catch((err) => {
                    this.setState({
                        errMess: 'Unable to find doctor schedule'
                    })
                })
        }
        ...
        return(
            <div className='fluid-container'>
                ...
                <Form onSubmit={this.handleFormSubmit}>
                    ...
                    <FormGroup row>
                        <Label sm={4} htmlFor='form-appointment'>Select Slot:</Label>
                        <Col sm={6}>
